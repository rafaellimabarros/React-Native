...
class Lista extends Component{
    ...
    mostraLikes(likers){
      ...
      if(feed.likers <= 0){
        ...
        return(<Text style={styles.curtidas}> {feed.likers} {feed.likers > 1 ? 'Curtidas' : 'Curtida'} </Text>)
      }
    }
    ...
    like(){
      ...
      if(feed.likeada === true){
        this.setState({
          feed: {
            ...feed, // mão na roda, ele pega o conteudo do objeto e muda só o que está embaixo
            likeada: false,
